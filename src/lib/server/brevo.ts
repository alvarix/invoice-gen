...
/**
 * Send agreement email to client via Brevo transactional API.
 * @param to - recipient email address
 * @param toName - recipient name
 * @param agreementTitle - title of the agreement
 * @param publicUrl - full URL to public agreement acceptance page
...
export async function sendAgreementEmail(
  ...
  const res = await fetch('https://api.brevo.com/v3/smtp/email', {
    ...
    body: JSON.stringify({
      ...
      subject: `${agreementTitle} — please review and accept`,
      htmlContent: `
        <p>Hi ${toName},</p>
        <p>Please review and accept the following agreement: <strong>${agreementTitle}</strong></p>
